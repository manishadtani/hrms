...
<style>
    ...
    .breadcrumb-nav{display:flex;align-items:center;gap:6px;font-size:.82rem;color:#94a3b8;margin-top:6px}
    .breadcrumb-nav a{color:#06b6d4;text-decoration:none;font-weight:600;transition:color .2s}
    .breadcrumb-nav a:hover{color:#0891b2}
    .breadcrumb-nav .sep{color:#cbd5e1}
    .month-filter{display:flex;align-items:center;gap:10px}
    .month-filter input[type="month"]{padding:10px 16px;border:2px solid #e5e7eb;border-radius:12px;font-family:'Inter',sans-serif;font-size:.9rem;font-weight:600;color:#374151;transition:all .3s;background:#fff}
    ...
    .status-chip{padding:8px 18px;border-radius:12px;font-weight:700;font-family:'Inter',sans-serif;font-size:.82rem;display:flex;align-items:center;gap:6px;letter-spacing:.3px}
    .chip-waiting{background:#fef3c7;color:#92400e}
    .chip-working{background:#dcfce7;color:#166534}
...
<div class="att-page">
    ...
    <div class="page-header fade-up">
        ...
        <form class="month-filter" method="GET" action="{{ route('manager.attendance.my') }}">
    ...
    <div class="today-card fade-up">
        @if(!$todayAttendance)
            ...
            <div class="today-info">
                ...
                <p>Today, {{ now()->format('l d M Y') }} — Attendance not yet recorded</p>
            </div>
            <span class="status-chip chip-waiting"><i class="bi bi-clock-history"></i> Awaiting</span>
        @elseif(!$todayAttendance->clock_out)
            ...
            <span class="status-chip chip-working"><i class="bi bi-activity"></i> In Progress</span>
        @else
            ...
            <span class="status-chip chip-done"><i class="bi bi-check-lg"></i> Complete</span>
        @endif
    </div>
