    ...
    <div class="form-card">
        <div class="form-card-header">
            ...
            <div class="header-text">
                ...
                <p>Compose a new announcement for the organization</p>
            </div>
        </div>
            ...
            <form action="{{ route('admin.announcements.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <textarea name="content" id="content" rows="6"
                              ...
                              placeholder="Write the announcement content here..." required>{{ old('content') }}</textarea>
                    @error('content')
                        <div class="error-msg"><i class="bi bi-exclamation-circle"></i> {{ $message }}</div>
                    @enderror
                ...
                <div class="form-group">
                    ...
                    @error('status')
                        <div class="error-msg"><i class="bi bi-exclamation-circle"></i> {{ $message }}</div>
                    @enderror
                    <div class="hint-text">Draft announcements won't be visible to employees</div>
                </div>
                ...
                <div class="form-actions">
                    <button type="submit" class="btn-submit">
                        <i class="bi bi-check-lg"></i> Create Announcement
                    </button>
