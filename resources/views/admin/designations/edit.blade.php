    ...
    <div class="form-card">
        <div class="form-card-header">
            ...
            <div class="header-text">
                ...
                <p>Update details for {{ $designation->name }}</p>
            </div>
        </div>
            ...
            <form action="{{ route('admin.designations.update', $designation) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" id="description" rows="3"
                              ...
                              placeholder="Brief description of this designation...">{{ old('description', $designation->description) }}</textarea>
                    @error('description')
                        <div class="error-msg"><i class="bi bi-exclamation-circle"></i> {{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="toggle-group">
                    ...
                    <div class="toggle-label">
                        Active
                        <small>Inactive designations won't appear in selection lists</small>
                    </div>
                </div>
                ...
                <div class="form-actions">
                    <button type="submit" class="btn-submit">
                        <i class="bi bi-check-lg"></i> Update Designation
                    </button>
                    <a href="{{ route('admin.designations.index') }}" class="btn-cancel">
