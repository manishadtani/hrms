    ...
    <div class="form-card">
        <div class="form-card-header">
            ...
            <div class="header-text">
                ...
                <p>Update details for <strong>{{ $leaveType->name }}</strong></p>
            </div>
        </div>
            ...
            <form action="{{ route('admin.leave-types.update', $leaveType) }}" method="POST">
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label for="name">Leave Type Name <span class="req">*</span></label>
                    ...
                    <div class="form-group" style="max-width: 160px;">
                        ...
                        <input type="text" name="code" id="code"
                               ...
                               placeholder="e.g. CL" maxlength="10" required
                               style="text-transform: uppercase;">
                        @error('code')
                            <div class="error-msg"><i class="bi bi-exclamation-circle"></i> {{ $message }}</div>
                        @enderror
                        <div class="hint-text">Max 10 characters</div>
                    </div>
                </div>

                {{-- Days Per Year --}}
                <div class="form-group">
                    <label for="days_per_year">Days Per Year <span class="req">*</span></label>
                    <input type="number" name="days_per_year" id="days_per_year"
                           class="{{ $errors->has('days_per_year') ? 'input-error' : '' }}"
                           value="{{ old('days_per_year', $leaveType->days_per_year) }}"
                           placeholder="e.g. 12" min="0" required>
                    @error('days_per_year')
                        <div class="error-msg"><i class="bi bi-exclamation-circle"></i> {{ $message }}</div>
                    @enderror
                    <div class="hint-text">Number of allowed days per year for this leave type</div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" id="description" rows="3"
                              ...
                              placeholder="Brief description of this leave type...">{{ old('description', $leaveType->description) }}</textarea>
                    @error('description')
                        <div class="error-msg"><i class="bi bi-exclamation-circle"></i> {{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="toggle-group">
                    ...
                    <div class="toggle-label">
                        Active
                        <small>Inactive leave types won't be available for new requests</small>
                    </div>
                </div>
